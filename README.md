...
Script Python para traduzir arquivos de texto grandes de qualquer idioma para outro, utilizando a API gratuita do Google Translate. Para contornar os limites de tamanho da API, o arquivo é automaticamente dividido em pedaços (_chunks_) menores, traduzidos individualmente e depois remontados em um único arquivo de saída.
...
2. O conteúdo é dividido em pedaços de `chunk_size` caracteres.
...
### 3. Ajuste os parâmetros no script
...
## Personalizando o tamanho dos pedaços
